<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cad_artista.aspx.cs" Inherits="UnderWorld.cad_artista" %>
        ...
        <div class="container-fluid">
            <div class="row mt-3">
                ...
                <div class="col-12 col-md-6 mb-3 text-center">
                    ...
                    <asp:Button class="btnAspx" Text="Artistas" ID="btnCadArtista" runat="server" />
                ...
                <div class="col-12 col-md-6 mb-3 text-center">
                    ...
                    <input type="text" id="txtArtista" runat="server" value="" class="form-control" />
                </div>
                ...
                <div class="col-12 col-md-12 mb-3 text-center">
                   <img src="#" id="fotoArtista" alt="foto artista" runat="server" style="width: 200px; height: 200px;" />
                </div>
